...
m1.cum.abs<-lmer(LRR_cum.abs~MAP_rescale*delta.P1_rescale+
                   duration_rescale+delta.P1_rescale:treatment.direction+
...
m1.best2<-lmer(LRR_S~delta.P1_rescale+MAP_rescale+
                 +duration_rescale+
                 (1|study:site:SiteBlock),REML=T,data=Div.data_local, na.action="na.fail")
anova(m1.best2)
Anova(m1.best2)
...
m1.best3<-lmer(LRR_S~delta.P1_rescale+MAP_rescale+
                 delta.P1_rescale:treatment.direction+duration_rescale+
                 (1|study:site:SiteBlock),REML=T,data=Div.data_local, na.action="na.fail")
anova(m1.best3)
Anova(m1.best3)
...
m1.best5<-lmer(LRR_S~MAP_rescale*delta.P1_rescale+
                 duration_rescale+delta.P1_rescale:treatment.direction+
                 (1|study:site:SiteBlock),REML=T,data=Div.data_local, na.action="na.fail")
anova(m1.best5)
Anova(m1.best5)
...
m2.best1<-lmer(LRR_SPie~delta.P1_rescale+delta.P1_rescale:treatment.direction+
                 (1|study:site:SiteBlock),REML=T,data=Div.data_local, na.action="na.fail")
anova(m2.best1)
Anova(m2.best1)
...
#simplest model including delta P, delta AIC 2.3
...
m4.best2<-lmer(LRR_betaSPie~duration_rescale+delta.P1_rescale*MAP_rescale+
              (1|study:site:SiteBlock),REML=T,data=Div.data_local, na.action="na.fail")
anova(m4.best2)
Anova(m4.best2)
...
m4.best4<-lmer(LRR_betaSPie~delta.P1_rescale+MAP_rescale+
               +(1|study:site:SiteBlock),REML=T,data=Div.data_local, na.action="na.fail")
anova(m4.best4)
Anova(m4.best4)
...
m4.best6<-lmer(LRR_betaSPie~duration_rescale+delta.P1_rescale+delta.P1_rescale:treatment.direction+
                 (1|study:site:SiteBlock),REML=T,data=Div.data_local, na.action="na.fail")
anova(m4.best6)
Anova(m4.best6)
...
m7.best3<-lmer(LRR_gammaSn~MAP_rescale*delta.P1_rescale+delta.P1_rescale:treatment.direction
               + (1|study:site),  REML=F,data=Div.data_gamma, na.action="na.fail")
...
m6.best2<-lmer(LRR_gammaSPie~delta.P1_rescale+
                 (1|study:site),REML=T,data=Div.data_gamma, na.action="na.fail")
anova(m6.best2)
Anova(m6.best2)
...
m6.best5<-lmer(LRR_gammaSPie~delta.P1_rescale+MAP_rescale+
                 (1|study:site),REML=T,data=Div.data_gamma, na.action="na.fail")
anova(m6.best5)
Anova(m6.best5)
...
m6.best6<-lmer(LRR_gammaSPie~delta.P1_rescale+duration_rescale+
                 (1|study:site),REML=T,data=Div.data_gamma, na.action="na.fail")
anova(m6.best6)
Anova(m6.best6)
r.squaredGLMM(m6.best6) 
qqnorm(resid(m6.best6))
hist(resid(m6.best6))

m6.best7<-lmer(LRR_gammaSPie~duration_rescale+
                 (1|study:site),REML=T,data=Div.data_gamma, na.action="na.fail")
anova(m6.best7)
Anova(m6.best7)
r.squaredGLMM(m6.best7) 
qqnorm(resid(m6.best7))
hist(resid(m6.best7))
...
m6.best8<-lmer(LRR_gammaSPie~delta.P1_rescale+delta.P1_rescale:treatment.direction+
                 (1|study:site),REML=T,data=Div.data_gamma, na.action="na.fail")
anova(m6.best8)
Anova(m6.best8)
r.squaredGLMM(m6.best8) 
qqnorm(resid(m6.best8))
hist(resid(m6.best8))


m6.best9<-lmer(LRR_gammaSPie~delta.P1_rescale+delta.P1_rescale:treatment.direction+
                 (1|study:site),REML=T,data=Div.data_gamma, na.action="na.fail")
anova(m6.best9)
Anova(m6.best9)
r.squaredGLMM(m6.best9) 
qqnorm(resid(m6.best9))
hist(resid(m6.best9))