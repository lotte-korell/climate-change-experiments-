...
m3.cum.abs<-lmer(LRR_cum.abs~MAP_rescale:delta.P1_rescale+
                   (1|study:site:SiteBlock:treat.duration.m), REML=T,data=Cum.abs_local,na.action="na.fail")
summary(m3.cum.abs)
anova(m3.cum.abs)
Anova(m3.cum.abs)
...
m4.cum.abs<-lmer(LRR_cum.abs~MAT_rescale+delta.P1_rescale+
                   (1|study:site:SiteBlock:treat.duration.m), REML=T,data=Cum.abs_local,na.action="na.fail")
summary(m4.cum.abs)
anova(m4.cum.abs)
Anova(m4.cum.abs)
...
set.seed(1234)
m3.cum_boot<-bootMer(m3.cum, FUN = fixef, nsim = 1000)
m3.cum_boot#t1 = MAP, t2 = delta P, t3 = delta P * MAP
m3.cum_ci1<-boot.ci(m3.cum_boot, index =1, type = "perc")
m3.cum_ci1#delta P
m3.cum_ci2<-boot.ci(m3.cum_boot, index =2, type = "perc")
m3.cum_ci2#MAP
m3.cum_ci3<-boot.ci(m3.cum_boot, index =3, type = "perc")
m3.cum_ci3#delta P*MAP
...
m2.best4<-lmer(LRR_SPie~MAT_rescale+delta.P1_rescale+
                 (1|study:site:SiteBlock:treat.duration.m),REML=T,data=Div.data_local,na.action="na.fail")
anova(m2.best4)
Anova(m2.best4)
...
m3.best2<-lmer(LRR_betaS~MAP_rescale+
                 +(1|study:site:SiteBlock:treat.duration.m),REML=T,data=Div.data_local, na.action="na.fail")
anova(m3.best2)
Anova(m3.best2)
...
m4.best3<-lmer(LRR_betaSPie~MAP_rescale*delta.P1_rescale+MAT_rescale+
                 +(1|study:site:SiteBlock:treat.duration.m),REML=T,data=Div.data_local, na.action="na.fail")
anova(m4.best3)
Anova(m4.best3)
...
m4.best4<-lmer(LRR_betaSPie~MAP_rescale+delta.P1_rescale+
                 +(1|study:site:SiteBlock:treat.duration.m),REML=T,data=Div.data_local, na.action="na.fail")
anova(m4.best4)
Anova(m4.best4)
...
m5.best3<-lmer(LRR_gammaS~delta.P1_rescale+MAP_rescale+
                 (1|study:site:treat.duration.m),REML=T,data=Div.data_gamma, na.action="na.fail")
anova(m5.best3)
Anova(m5.best3)
...
m5.best4<-lmer(LRR_gammaS~delta.P1_rescale+MAT_rescale+
                 (1|study:site:treat.duration.m),REML=T,data=Div.data_gamma, na.action="na.fail")
anova(m5.best4)
Anova(m5.best4)
...
m5.best5<-lmer(LRR_gammaS~MAT_rescale+
                 (1|study:site:treat.duration.m),REML=T,data=Div.data_gamma, na.action="na.fail")
anova(m5.best5)
Anova(m5.best5)
